...
if(button.id === "Kur2") {
  ...
  if(button.id === "Kur3") {
    ...
    if(button.id === "Kur4") {
      ...
      message.guild.channels.create('rollogchannel', {type: 'text'}).then(c => c.setParent(parent.id));
      message.guild.channels.create('messagelogchannel', {type: 'text'}).then(c => c.setParent(parent.id));
