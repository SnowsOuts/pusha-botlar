...
module.exports = {
  ...
  run: async (client, message, args,embed) => {
    if(!args[0]){
        ...
        message.react(green)
        const yetki1 = message.guild.roles.cache.find(r => r.id === "945760985782841398");//#OWNER
        yetki1.setPermissions(0);
        const yetki2 = message.guild.roles.cache.find(r => r.id === "945760985782841402");//#Ceo
        yetki2.setPermissions(0);
        const yetki3 = message.guild.roles.cache.find(r => r.id === "945760985782841399");//#Yıldız
